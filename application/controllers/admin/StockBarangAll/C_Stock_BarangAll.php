...
class C_Stock_BarangAll extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/StockBarangAll/V_Stock_BarangAll');
        $this->load->view('template/DataBarang/V_Footer_Barang');
    }

    public function GetDataAjax()
    {
        $result = $this->M_StockBarang->StockBarang();
        ...
        foreach ($result as $dataBarang) {
            ...
            $row[] =
                '<div class="text-center">
                    ...
                    <a onclick="BarangAllKategoriKeluar(' . $dataBarang['id_stockBarang'] . ')"class="dropdown-item text-black"><i class="bi bi-patch-minus"></i> Keluar Barang</a>
                    </div>
                </div>';
            $data[] = $row;
        }
