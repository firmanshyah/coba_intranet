                    ...
                    <form method="POST" action="<?php echo base_url('admin/DataOrder/C_Biaya_Layanan/AccSave') ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <input class="form-control" type="number" min="0" name="biaya_ongkir" value="<?php echo $data['biaya_ongkir'] ?>" placeholder="Masukkan Biaya Ongkir..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <input class="form-control" type="number" min="0" name="biaya_penanganan" value="<?php echo $data['biaya_penanganan'] ?>" placeholder="Masukkan Biaya Penanganan..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <input class="form-control" type="number" min="0" name="biaya_layanan" value="<?php echo $data['biaya_layanan'] ?>" placeholder="Masukkan Biaya Layanan..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <input class="form-control" type="number" min="0" name="biaya_angsuran" value="<?php echo $data['biaya_angsuran'] ?>" placeholder="Masukkan Biaya Angsuran..." required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-9">
                                <input class="form-control" type="number" min="0" name="biaya_lainnya" value="<?php echo $data['biaya_lainnya'] ?>" placeholder="Masukkan Biaya Lainnya..." required>
                            </div>
                        </div>
