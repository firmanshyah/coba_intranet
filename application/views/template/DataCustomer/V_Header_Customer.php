...
<head>
    <!-- Basic Page Info -->
    <meta charset="utf-8" />
    <title>Data Customer - Infly Networks</title>

    <!-- Site favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url(); ?>vendors/images/logo-only.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url(); ?>vendors/images/logo-only.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>vendors/images/logo-only.png" />
